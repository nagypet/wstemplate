...
keytool.exe -genkeypair -alias %ALIAS% -keyalg RSA -keysize 2048 -validity 3650 -dname "CN=localhost" -keypass %KEYPASS% -keystore %SERVER_STORENAME% -storepass %STOREPASS% -ext san=dns:localhost,dns:host.docker.internal,dns:auth-service,dns:scalable-service-1,dns:scalable-service-2,dns:scalable-service-3
