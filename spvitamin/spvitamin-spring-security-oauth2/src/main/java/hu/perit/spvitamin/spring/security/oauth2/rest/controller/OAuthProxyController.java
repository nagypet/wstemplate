...
//        this.httpServletResponse.sendRedirect(authorizationUri);
        ...
        {
            String redirectUri = getBaseUrl() + "/oauth2/authorization/microsoft";
            log.info(MessageFormat.format("OAuth authorization redirect to {0}", redirectUri));
    ...
    {
        //baseUrl + "/oauth2/callback/microsoft"
